...
<body>
    ...
    <form method="POST" action="{{route('administrador.create-torneo')}}">
        <h2>REGÍSTRAR NUEVO TORNEO</h2>
        @csrf
        <div class="row">
            ...
            <div class="input-gruop">
                ...
                <input type="text" id="organizadorInput" name="organizador" required>
            </div>
        </div>
        <div class="row">
            <div class="input-gruop">
                <label for="nombre_torneoInput">Nombre del torneo: </label>
                <input type="text" id="nombre_torneoInput" name="nombre_torneo" required autocomplete="disable">
            </div>
            <div class="input-gruop">
                <label for="modalidadInput">Modalidad: </label>
                <input type="text" id="modalidadInput" name="modalidad" required autocomplete="disable">
            </div>
        </div>
        <div class="row">
            <div class="input-gruop">
